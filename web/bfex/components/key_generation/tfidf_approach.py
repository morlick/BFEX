...
class TfidfApproach(KeyGenerationApproach):
    ...
    def generate_keywords(self, text):
        ...
        #other options: top ~5 or top 1/4
        threshold = 0.5

        #Defines the corpus: blank search = all documents
        #Other options: All members of a certain faculty, only that Prof
...
if __name__ == "__main__":
    ...
    search = Document.search().query('match', faculty_id= "356").execute()
    task = TfidfApproach()
